...
class BraitenbergVehicle:
    ...
    def compute_wheel_speeds(self, left_in, right_in):
        ...
        if(self._vehicle_type == self.TYPE_A):
            ...
            return(right_in*self._f_2,left_in*self._f_1)
        elif(self._vehicle_type == self.TYPE_C):
            if(self._f_1 > self._f_2):
                return(left_in * self._f_1,right_in * self._f_2)  
            elif(self._f_1 < self._f_2):
                return(right_in * self._f_2,left_in * self._f_1)
            else:
                return((left_in * self._f_1) + (right_in * self._f_2),(left_in * self._f_1) + (right_in * self._f_1))